      ...
      >
        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-4">Additional Services</h1>
            <p className="text-xl text-white">Comprehensive travel solutions to enhance your journey</p>
          </div>
        </div>
      </div>
